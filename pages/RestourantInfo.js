export default function RestourantInfo() {
	return (
		<>
			<section className="section-after-nav">
				<div className="container">
					<div className="es-section-header section-header about-header">Рестораны</div>
					<div className="es-about-container row d-flex justify-content-between">
						<div className="col-lg-7 es-info-text-content">
						...
						<div className="col-lg-5">
							<img className="img-fluid" src="img/Restorans.svg" alt="" />
						</div>
					</div>
				</div>
			</section>
