                  ...
                  <div className="product-wrapper">
                    <div className="inner-product-wrapper">
                      <div className="favourite-img position-relative">
                        <img className="img-fluid w-100" src="img/restourant-page-product.svg" alt="" />
                    ...
                    <div className="inner-product-wrapper">
                      ...
                      <div className="favourite-product-info">
                        ...
                        <div className="product-qty-btns">
                          <button className="btn es-minus-restourant">-</button>
                          <span>1</span>
                          <button className="btn es-plus-restourant">+</button>
                        </div>
                      </div>
                    </div>
                  </div>
